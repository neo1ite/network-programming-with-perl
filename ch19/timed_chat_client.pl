#!/usr/bin/perl -w
# file: timed_chat_client.pl
# Figure 19.9: chat client using UDP, with regular STILL_HERE messages
...
use constant ALIVE_INTERVAL => 30;  # send a STILL_HERE every 30 sec
